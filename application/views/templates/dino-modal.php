...
<div class="modal-text-content">
	...
	?>
	<?php
	echo "<img class='audio' data-href='" . $kiki['file_name'] . "' src='" . asset_url('images/audio.png') . "' alt='Audio Icon' /></a>";
	echo "<img class='audiostop' src='" . asset_url('images/audiostop.png') . "' alt='Audio Stop Icon' /></a>";
	?>
</div>
