<template>
  <div>
    <header class="header">
      <h1 class="header__h1">
        <router-link class="header__a header__a--title" to="/">Hello, I'm Dinokiki and this is my home!</router-link>
      </h1>
      <nav>
        <ul class="header__nav-wrapper">
          ...
          <li class="header__li">
            <router-link class="header__a" to="/about">About</router-link>
          </li>
          <li class="header__li">
            <router-link class="header__a" to="/games">Games</router-link>
          </li>
          <li class="header__li">
            <router-link class="header__a" to="/send">Send your Kiki</router-link>
          </li>
        </ul>
      </nav>
    </header>    
    ...
    <footer class="footer">
      <nav>
        <ul class="footer__nav-wrapper">
          <li class="footer__li">
            <router-link class="footer__a" to="/" aria-label="icon that represents a link to home page">
          ...
          <li class="footer__li">
            <router-link class="footer__a" to="/about" aria-label="icon that represents a link to about page">        
              <svg class="footer__svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          ...
          <li class="footer__li">
            <router-link class="footer__a" to="/game" aria-label="icon that represents a link to games page">
              <svg class="footer__svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          ...
          <li class="footer__li">
            <router-link class="footer__a" to="/send" aria-label="icon that represents a link to send a kiki page">
              <svg class="footer__svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                <path d="M20 7.093v-5.093h-3v2.093l3 3zm4 5.907l-12-12-12 12h3v10h7v-5h4v5h7v-10h3zm-5 8h-3v-5h-8v5h-3v-10.26l7-6.912 7 6.99v10.182z"/>
              </svg>
            </router-link>
